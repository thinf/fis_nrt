...
%     end
   ...
   % plot(x',y','r','linewidth',1)
    ...
    ctdd{2} = LoadFISSCTDData('FSW2');
    ctdd{3} = LoadFISSCTDData('FSE1');
    ctdd{4} = LoadFISSCTDData('FSE2');
    cd(odir);
    ...
    cell2col(s,p,th,fla);
    col2mat(s,p,th,fla);
    plot(th(:,cs{i_}),p(:,cs{i_}),'color',col(i_,:));
    end
...
thscr2png(['af_CTD_' stn '_' datestr(now,'yyyy_mm') '_' num2str(i)],'150',outpath)
end
%%
